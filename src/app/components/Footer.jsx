...
useEffect(() => {
  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    ...
    >
      <div>
        <p className="font-medium text-green-800">Services</p>
      ...
      <div>
        <p className="font-medium text-green-800">Helpful Links</p>
    ...
    <p className="text-xs text-green-800">Copyright &copy; {year} StarBrews All rights reserved.</p>
  </div>
</footer>
    )
}